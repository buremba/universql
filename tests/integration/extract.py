...
class TestConnectivity:
    def test_invalid_auth(self):
        # we don't have many tests here because snowflake blocks in case you try invalid pass for 3 times
        with universql_connection(password="invalidPass", warehouse=None) as conn:
...
class TestSelect:
    ...
    # TODO: add the create stage for landing_stage in the pre_hook
    def test_copy_into_for_ryan(self):
        with universql_connection(warehouse=None) as conn:
            result = execute_query(conn, """
             ...
             FROM @landing_stage/initial_objects/device_metadata.csv
